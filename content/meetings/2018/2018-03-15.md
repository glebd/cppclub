...
_smf_ is a new RPC system and code generation like gRPC, Cap'n'Proto, Apache Thrift, etc, but designed for microsecond tail latency.
...
![Unicode in C++](/img/cpp-unicode.png)
